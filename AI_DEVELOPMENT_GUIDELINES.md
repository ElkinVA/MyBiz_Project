...
7. Ты работаешь в /workspace. наша схема работы такая: я из веб версии qwen отправляю изменения, которые ты делаешь, на гитхаб (нажимаю "опубликовать на github"), потом на своем компьютере делаю [
git fetch origin
git checkout main
